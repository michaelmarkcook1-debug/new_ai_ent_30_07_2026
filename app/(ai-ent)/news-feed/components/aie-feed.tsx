...
function sentimentBadge(s: FeedItem["sentiment"]) {
  ...
  return (
    <span className="inline-flex rounded-full bg-base-200 px-2 py-0.5 text-xs font-medium text-base-content/80">
      Mixed
    </span>
  );
}
    ...
    <section className="rounded-lg border border-base-300 bg-base-100">
      <div className="flex flex-wrap items-center justify-between gap-2 border-b border-base-300 px-3 py-2.5">
        <div className="flex flex-wrap items-center gap-2">
          <h3 className="text-sm font-bold">AI market brief (historical seed)</h3>
          <LaneBadge lane="aie" />
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex flex-wrap items-start justify-between gap-x-3 gap-y-1">
                    <p className="measure text-sm font-semibold leading-snug">{n.title}</p>
                    <span
                  ...
                  <p className="measure mt-0.5 text-sm leading-snug text-base-content/85">
                    {n.summary}
                  </p>
