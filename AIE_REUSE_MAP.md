...
- lib/use-cases.ts (918 lines, 85 workflow records). The enterprise AI workflow taxonomy: 60-plus workflows tiered quick, guided, advanced, with industries, commonInputs, regulatoryFlags, and complexity. Recommendation: PORT as-is if the demo includes any assessment flow; the taxonomy is reusable on its own.
