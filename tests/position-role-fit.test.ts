...
const area = (over: Partial<Opportunity> = {}): Opportunity => ({
  ...
  keyConstraint: null,
  priority: "LOW",
  priorityWhy: "LOW priority: nothing retrieved connects it to this company.",
  reliability: {
    score: 2,
    meaning: "The sector runs this. Nothing retrieved about this company speaks to it.",
    basis: "Reliability 2 of 5.",
  },
  marketIds: [],
  ...over,
});
